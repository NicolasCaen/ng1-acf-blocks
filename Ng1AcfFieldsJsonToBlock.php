...
/**
 * Classe utilitaire pour la gestion des blocs ACF
 * 
 * Fournit des outils pour :
 * - Charger automatiquement les blocs ACF depuis le thème
 * - Synchroniser les configurations JSON des champs ACF
 * - Gérer les assets (JS) des blocs
 * 
